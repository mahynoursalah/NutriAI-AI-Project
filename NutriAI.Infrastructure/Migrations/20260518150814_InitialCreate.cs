        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoalWeightKg = table.Column<double>(type: "float", nullable: false),
                    TimelineWeeks = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyWaterTargetMl = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeightChangeKg = table.Column<double>(type: "float", nullable: false),
                    AverageCalories = table.Column<int>(type: "int", nullable: false),
                    HydrationScore = table.Column<int>(type: "int", nullable: false),
                    BestDay = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WorstDay = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RecommendationsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DailyCaloriesJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WeightTrendJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HydrationDaysJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Carbs = table.Column<double>(type: "float", nullable: false),
                    Fat = table.Column<double>(type: "float", nullable: false),
                    PerServingCalories = table.Column<int>(type: "int", nullable: false),
                    PerServingProtein = table.Column<double>(type: "float", nullable: false),
                    PerServingCarbs = table.Column<double>(type: "float", nullable: false),
                    PerServingFat = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeAnalyses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecipeAnalyses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RecipeAnalyses_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIChats_UserId_Context_CreatedAt",
                table: "AIChats",
                columns: new[] { "UserId", "Context", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealPlans_UserId_CreatedAt",
                table: "MealPlans",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeAnalyses_RecipeId",
                table: "RecipeAnalyses",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeAnalyses_UserId",
                table: "RecipeAnalyses",
                column: "UserId");
